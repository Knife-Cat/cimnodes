local t={
  ...
  imnodes_SetImGuiContext={
    [1]={
      ...
      stname=""},
    ["(ImGuiContext*)"]=nil},
  imnodes_SetImguiAssert={
    [1]={
      args="(ImAssertFunc func)",
      argsT={
        [1]={
          name="func",
          type="ImAssertFunc"}},
      argsoriginal="(ImAssertFunc func)",
      call_args="(func)",
      cimguiname="imnodes_SetImguiAssert",
      defaults={},
      funcname="SetImguiAssert",
      location="imnodes:245",
      namespace="imnodes",
      ov_cimguiname="imnodes_SetImguiAssert",
      ret="void",
      signature="(ImAssertFunc)",
      stname=""},
    ["(ImAssertFunc)"]=nil},
...
t.imnodes_SetImguiAssert["(ImAssertFunc)"]=t.imnodes_SetImguiAssert[1]
